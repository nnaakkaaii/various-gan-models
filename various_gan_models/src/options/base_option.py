...
class BaseOption:
    ...
    def initialize(self, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument('--out_size', type=int, default=256, choices=[28, 128, 256], help='出力画像の大きさ')
        parser.add_argument('--output_nch', type=int, default=3, help='# of output image channels: 3 for RGB and 1 for grayscale')
