...
init_weight_options: Dict[str, Callable[[argparse.ArgumentParser], argparse.ArgumentParser]] = {
    'normal': normal_init_weight.modify_init_weight_commandline_options,
    'kaiming': lambda x: x,
    'xavier': xavier_init_weight.modify_init_weight_commandline_options,
    'orthogonal': orthogonal_init_weight.modify_init_weight_commandline_options,
}
