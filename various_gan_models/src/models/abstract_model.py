...
class AbstractModel(metaclass=abc.ABCMeta):
    ...
    def __init__(self, opt: argparse.Namespace) -> None:
        ...
        self.modules: Dict[str, Union[nn.Module, nn.DataParallel]] = {}
        self.optimizers: Dict[str, Any] = {}
        self.schedulers: Dict[str, Any] = {}
        self.losses: Dict[str, Any] = {}  # 継承後のクラスで定義
        self.criteria: Dict[str, Any] = {}  # 継承後のクラスで定義
        self.metric = 0  # used for scheduler 'plateau'
    ...
    def save_current_image(self, epoch: Union[int, str]) -> None:
        """Save current images to the disk.
        """
        pass
